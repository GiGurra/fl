...
NOTE: While golang's defer runs the deferred func at the end of the current function, Fluffy's defer runs the
deferred expression at the end of the current scope.
